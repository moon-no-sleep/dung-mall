...
moon-no-sleep: 基于Estrocom做内容, 逐步修改中. dung-mall
...
1. **Add your products**Edit `src/utils/productData.js` with your product details.
2. **Replace images**Swap the placeholders in `public/assets/` with your own images.
3. **Update categories & product pages**Edit the frontmatter in `src/pages/category/` and `src/pages/products/`.
4. **Customize homepage**Edit `src/pages/index.astro` to showcase your story.
...
Want me to build it for you? [Email me](mailto:2417789183@qq.com) and I’ll set up your store quickly.

---

## 💡 About Me

Hi! I’m moon-no-sleep, a developer specializing in modern, fast, and accessible e-commerce solutions. I help businesses launch online stores that look great, perform well, and attract customers.
...
[Contact me](mailto:2417789183@qq.com) to get started.
